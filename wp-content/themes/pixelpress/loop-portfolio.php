...
if ( have_posts() ) : $count = 0; ?>
	<header class="<?php echo $filtering_css_class; ?> section-title portfolio">
		...
		<?php
			...
			else if ( $screen_type == 'post-type-archive' ) { apply_filters( 'woo_portfolio_type_archive_title', __( 'Portfolio', 'woothemes' ) ) ; }
			else if ( $screen_type == 'taxonomy' ) { echo $archive_title; }
