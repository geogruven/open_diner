...
<div class="controls-container">
		<ul class="slides">
			...
			<?php
				...
				$background_repeat = get_post_meta($post->ID, 'background_repeat', true);
			...
			<li class="slide" style="<?php if ($background_color != ''): ?>background-color: <?php echo esc_attr($background_color); ?>;<?php endif; ?> <?php if ($background_image != ''): ?>background-image: url(<?php echo esc_attr($background_image); ?>); background-repeat: url(<?php echo esc_attr($background_repeat); ?>);<?php endif; ?>">
	    	    	...
	    	    	<article class="slide-content col-full <?php if ( !$has_embed ) { echo 'not-video'; } ?>">
    	    			...
    	    			<div class="entry">
	        				...
	        				<?php
		        				...
		        				} elseif ( $slidertype == 'Carousel' && !$has_embed ) {
		        					woo_image( 'width=911&height=' . $settings['featured_height'] . '&class=slide-image&link=img&noheight=true' );
		        				} else {
		        					echo $has_embed;
		        				}
	        				?>
