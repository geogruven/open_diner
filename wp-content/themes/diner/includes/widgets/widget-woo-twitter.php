...
class Woo_Twitter extends WP_Widget {
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <?php if ($title) echo $before_title . $title . '<span class="username"><a href="http://twitter.com/' . $username . '" title="' . __('Follow',woothemes) . ' ' . $username . ' ' . __('on Twitter',woothemes) . '">@' . $username . '</a></span>' . $after_title; ?>
