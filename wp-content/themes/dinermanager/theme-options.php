...
function theme_options_add_pages() {
    ...
    $icon = get_stylesheet_directory_uri() . '/functions/images/geo-icon.png';
                
    add_menu_page('Page Title', 'Diner Manager', 'manage_options', 'gm_options', 'gm_manage_options_do_page', $icon, 26);
    add_submenu_page('gm_options', 'Database Import', 'Import', 'manage_options', __FILE__ . 'import', 'gm_import_do_page');
 ...
 */
function gm_manage_options_do_page() {
