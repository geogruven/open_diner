...
if (!function_exists( 'the_widgets_init')) {
	function the_widgets_init() {
		...
		register_sidebar(array( 'name' =>  esc_attr( __( 'Homepage', 'woothemes' ) ), 'id' => 'homepage', 'description' => esc_attr( __( 'Main content area on the homepage.', 'woothemes' ) ), 'before_widget' => '<div id="%1$s" class="widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h3>', 'after_title' => '</h3>' ) );	
	}
}
